        ...
        <div className="flex items-center justify-between gap-5 bg-white border border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-30">
            ...
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    focus:ring-offset-2"
                >
                    <img src={user?.profileImageUrl} alt="profile" className="w-10 h-10 rounded-full hover:cursor-pointer"/>
                </button>
                        ...
                        <div className="py-1">
                            <button
                                ...
                                className="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-700
                                 hover:bg-gray-50 transition-colors duration-150 hover:cursor-pointer"
                            >
